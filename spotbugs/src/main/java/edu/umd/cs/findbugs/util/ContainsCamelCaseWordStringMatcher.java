...
/**
 * A StringMatcher that checks to see if a candidate string (assumed to be a camel-case word), when broken into
...
public class ContainsCamelCaseWordStringMatcher implements StringMatcher {
    ...
    /**
     * Constructor. This StringMatcher will match any string which, when broken into camel-case identifier components,
     * has a component which matches the (lower-cased) expected string value.
     *
     * @param expected
