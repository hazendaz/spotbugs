...
/**
 * Graph of Detector ordering constraints. It may represent ordering constraints between analysis passes, or ordering
 * constraints within a single pass. Edges flow from earlier detectors to later detectors.
 *
 * @see DetectorNode
 * @see ConstraintEdge
 * @see ExecutionPlan
