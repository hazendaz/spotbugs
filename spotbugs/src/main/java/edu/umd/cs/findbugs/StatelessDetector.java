 ...
 *
 * The idea of using this interface is questionable. Better for people writing stateless detectors to just not keep
 * around state they don't need, rather than depending on cloning and garbage collection.
 *
 */
