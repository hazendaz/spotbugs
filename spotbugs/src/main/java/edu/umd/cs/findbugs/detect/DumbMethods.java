...
public class DumbMethods extends OpcodeStackDetector {
    ...
    private final class RangeCheckSubDetector extends SubDetector {
        ...
        public void sawOpcode(int seen) {
            ...
            case Const.INVOKESPECIAL: {
                ...
                if ((m.getSignature().startsWith("([BII)") || m.getSignature().startsWith("([CII)")
        ...
        public void sawOpcode(int seen) {
            if (seen == Const.INVOKEVIRTUAL) {
                ...
                if ((CLASS_NAME_RANDOM.equals(classConstantOperand)
                        ...
                        && !isStreamMethod(getNameConstantOperand()) && (freshRandomOnTos || freshRandomOneBelowTos)) {
                    accumulator.accumulateBug(
    ...
    public void sawOpcode(int seen) {
            ...
            if (previousMethodCall != null && !stack.isJumpTarget(getPC())) {
                if ("toString".equals(called.getName())
                    ...
                    BugInstance bug = new BugInstance(this, "DM_BOXED_PRIMITIVE_FOR_PARSING", HIGH_PRIORITY)
                            ...
                            .describe(MethodAnnotation.SHOULD_CALL);
                    accumulator.accumulateBug(bug, this);
                } else if ("compareTo".equals(called.getName()) && "valueOf".equals(previousMethodCall.getName())
                    ...
                    if (primitiveType != null && (previousMethodCall.equals(rvo) || signature.equals(primitiveType))
                        ...
                        MethodDescriptor shouldCall = new MethodDescriptor(called.getClassDescriptor().getClassName(),
                                "compare", "(" + primitiveType + primitiveType + ")I", true);
        ...
        if ((seen == Const.INVOKESTATIC || seen == Const.INVOKEVIRTUAL || seen == Const.INVOKESPECIAL
                || seen == Const.INVOKEINTERFACE) && getSigConstantOperand().indexOf("Ljava/lang/Runnable;") >= 0) {
        ...
        try {
            ...
            case Const.LXOR:
                ...
                if (rhs.hasConstantValue(badValue) && (prevOpcode == Const.LDC || prevOpcode == Const.ICONST_0
                        || prevOpcode == Const.ICONST_M1 || prevOpcode == Const.LCONST_0)
            ...
            case 0:
                if (seen == Const.INVOKEVIRTUAL && CLASS_NAME_RANDOM.equals(getClassConstantOperand())
                        ...
                        || seen == Const.INVOKEVIRTUAL && CLASS_NAME_RANDOM.equals(getClassConstantOperand())
            ...
            if (!isPublicStaticVoidMain && seen == Const.INVOKESTATIC
                    ...
                    && getMethodName().indexOf("exit") == -1 && getMethodName().indexOf("Exit") == -1
                    && getMethodName().indexOf("crash") == -1 && getMethodName().indexOf("Crash") == -1
                    && getMethodName().indexOf("die") == -1 && getMethodName().indexOf("Die") == -1
