...
public class Strings {
    ...
    /**
     * This is intended to be semantically equivalent to <code>source.replace(find, repl)</code> but also compatible
     * with JDK 1.4.
     *
     * @param source
    ...
    /**
     * This is intended to be equivalent to <code>Arrays.toString(a)</code> but also compatible with JDK 1.4. This
     * concatenates the results of calling String.valueOf() on each element of the array, so this won't work well for
    ...
    /*
     * XML escape/unescape routines: extend functionality of org.apache.commons.lang.{un,}escapeXml() by supporting
     * low-value character escaping/unescaping
     */
    ...
    /**
     * Initializes the map of characters to be escaped and their corresponding escape sequences. This method will be
     * invoked automatically the first time a string is escaped/unescaped.
     *
    ...
    public static void initializeEscapeMap() {
        ...
        /*
         * synchronize the lazy initialization so things don't break if FindBugs ever becomes multi-threaded (and also
         * so FindBugs doesn't throw a warning about the thread safety of this operation)
         */
    ...
    /**
     * Escape XML entities and illegal characters in the given string. This enhances the functionality of
     * org.apache.commons.lang.StringEscapeUtils.escapeXml by escaping low-valued unprintable characters, which are not
     * permitted by the W3C XML 1.0 specification.
     *
     * @param s
     *            a string
     *
     ...
     * @see <a href="http://www.w3.org/TR/REC-xml/#charsets">Extensible Markup Language (XML) 1.0 (Fifth Edition)</a>
     * @see <a href=
     *      "http://commons.apache.org/lang/api/org/apache/commons/lang/StringEscapeUtils.html#escapeXml(java.lang.String)">org.apache.commons.lang.StringEscapeUtils
     *      javadoc</a>
     */
    ...
    /**
     * Initialize regular expressions used in unescaping. This method will be invoked automatically the first time a
     * string is unescaped.
     */
    public static boolean initializeUnescapePattern() {
        ...
        synchronized (unescapeInitLockObject) {
            ...
            try {
                ...
                /*
                 * the pattern is compiled from a final string, so this exception should never be thrown
                 */
    ...
    /**
     * Unescape XML entities and illegal characters in the given string. This enhances the functionality of
     * org.apache.commons.lang.StringEscapeUtils.unescapeXml by unescaping low-valued unprintable characters, which are
     * not permitted by the W3C XML 1.0 specification.
     *
     * @param s
     *            a string
     *
     ...
     * @see <a href="http://www.w3.org/TR/REC-xml/#charsets">Extensible Markup Language (XML) 1.0 (Fifth Edition)</a>
     * @see <a href=
     *      "http://commons.apache.org/lang/api/org/apache/commons/lang/StringEscapeUtils.html#unescapeXml(java.lang.String)">org.apache.commons.lang.StringEscapeUtils
     *      javadoc</a>
     */
    public static String unescapeXml(String s) {
        ...
        /*
         * we can't escape the string if the pattern doesn't compile! (but that should never happen since the pattern is
         * static)
         */
        ...
        /*
         * skip this expensive check entirely if there are no substrings resembling Unicode escape sequences in the
        ...
        if (s.contains("\\u")) {
            ...
            while (m.find() == true) {
                ...
                try {
                    ...
                    /*
                     * the static regular expression string should guarantee that this exception is never thrown
                     */
                ...
                if (slashes != null && slashes.length() % 2 == 0 && isInvalidXMLCharacter(escapeCode)) {
                    ...
                    /*
                     * slashes are apparently escaped when the string buffer is converted to a string, so double them to
                     * make sure the correct number appear in the final representation
                     */
