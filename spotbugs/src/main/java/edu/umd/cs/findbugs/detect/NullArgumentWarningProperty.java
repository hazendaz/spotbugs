...
public class NullArgumentWarningProperty extends AbstractWarningProperty {
    ...
    public static final NullArgumentWarningProperty ARG_DEFINITELY_NULL = new NullArgumentWarningProperty(
            "ARG_DEFINITELY_NULL", PriorityAdjustment.NO_ADJUSTMENT);
