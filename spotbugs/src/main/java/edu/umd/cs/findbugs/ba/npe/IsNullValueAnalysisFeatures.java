...
public interface IsNullValueAnalysisFeatures {
     ...
     */
    public static final boolean NO_SWITCH_DEFAULT_AS_EXCEPTION = SystemProperties
            .getBoolean("inva.noSwitchDefaultAsException");

    /**
     * Keep track of an extra branch, so we can distinguish conditionally-null values with two branches from
    ...
    /**
     * If this property is true, then resolution of nullness annotations is based on JSR-305 type qualifiers rather than
     * an AnnotationDatabase.
     */
