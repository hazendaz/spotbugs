...
/**
 * Iterator over the resources in an IScannableCodeBase. Note that some of the methods can throw InterruptedException.
 * This occurs when the analysis is canceled by interrupting the analysis thread.
 *
 * <p>
