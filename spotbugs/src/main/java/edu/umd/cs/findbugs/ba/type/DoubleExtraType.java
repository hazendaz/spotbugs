...
/**
 * Special type used to represent the "extra" part of a double value. We say that when a double is stored, local
 * <i>n</i> will have type double, and local <i>n+1</i> will have this type.
 *
