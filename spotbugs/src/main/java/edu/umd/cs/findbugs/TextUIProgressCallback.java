...
/**
 * Display FindBugs progress in the terminal window using ASCII codes. We assume that the terminal window is at least 80
 * characters wide.
 *
...
public class TextUIProgressCallback implements FindBugsProgress {
    ...
    private void analyzingClasses(int i) {
        String msg = String.format("Pass %d: Analyzing classes (%d / %d) - %02d%% complete", pass + 1, i, goal,
                (i * 100) / goal);
        printMessage(msg);
    }
