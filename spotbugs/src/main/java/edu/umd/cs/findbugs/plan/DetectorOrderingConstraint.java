...
public class DetectorOrderingConstraint {
    ...
    /**
     * Set whether or not this ordering constraint resulted from an ordering constraint having a single detector as its
    ...
    /**
     * Determine whether or not this ordering constraint resulted from an ordering constraint having a single detector
     * as its source (earlier detector). Such constraints automatically enable the source (earlier) detector if the
