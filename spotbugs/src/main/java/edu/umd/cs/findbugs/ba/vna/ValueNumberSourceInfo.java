...
public abstract class ValueNumberSourceInfo {
     ...
     */
    static @CheckForNull public BugAnnotation getFromValueNumber(ClassContext classContext, Method method,
        ...
        BugAnnotation variableAnnotation = findAnnotationFromValueNumber(method, location, valueNumber, vnaFrame,
                "VALUE_OF");
