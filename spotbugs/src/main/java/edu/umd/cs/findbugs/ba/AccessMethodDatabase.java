...
/**
 * A database of calls to "access" methods, i.e. the methods generated by the compiler when an inner class calls a
 * method on its outer class
 *
...
public class AccessMethodDatabase {
    ...
    /**
     * @param accessMethod
     *            The method descriptor for the access method
     * @param callerMethod
     *            The method descriptor for the inner class' "real" method
     * @param sourceLineAnnotation
     *            The annotation for the location where the inner class is calling the access method
     */
