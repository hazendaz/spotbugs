...
public abstract class ResourceValueFrameModelingVisitor
    ...
    /**
     * Override this to check for methods that it is legal to pass the instance to without the instance escaping. By
     * default, we consider all methods to be possible escape routes.
     *
     * @param inv
     *            the InvokeInstruction to which the resource instance is passed as an argument
