...
class Invocation {
    ...
    Invocation(int exitCode, @NonNull String exitSignalName, boolean executionSuccessful,
    ...
    JsonObject toJsonObject() {
        ...
        toolExecutionNotifications.stream().map(Notification::toJsonObject)
        ...
        toolConfigurationNotifications.stream().map(Notification::toJsonObject)
