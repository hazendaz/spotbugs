...
public abstract class FindBugsAnalysisFeatures {
    ...
    /**
     * "Relaxed" warning reporting mode. Rather than using hard-coded heuristics to decide when to suppress a warning,
     * report warnings freely and encode the heuristics as BugProperties (for consumption by a machine-learning-based
     * ranking algorithm).
     */
    public static final @AnalysisFeature int RELAXED_REPORTING_MODE = AnalysisFeatures.Builder
            .build("RELAXED_REPORTING_MODE");

    /**
     * Enable interprocedural analysis.
     */
    public static final @AnalysisFeature int INTERPROCEDURAL_ANALYSIS = AnalysisFeatures.Builder
            .build("INTERPROCEDURAL_ANALYSIS");

    public static final @AnalysisFeature int INTERPROCEDURAL_ANALYSIS_OF_REFERENCED_CLASSES = AnalysisFeatures.Builder
            .build("INTERPROCEDURAL_ANALYSIS_OF_REFERENCED_CLASSES");
