...
/**
 * Enum representing how a particular warning property is expected to affect its likelihood of being serious, benign, or
 * a false positive.
 *
...
public class PriorityAdjustment {
    ...
    public static final PriorityAdjustment A_LITTLE_BIT_LOWER_PRIORITY = new PriorityAdjustment(
            "A_LITTLE_BIT_LOWER_PRIORITY");

    /** Raise the priority a little */
    public static final PriorityAdjustment A_LITTLE_BIT_HIGHER_PRIORITY = new PriorityAdjustment(
