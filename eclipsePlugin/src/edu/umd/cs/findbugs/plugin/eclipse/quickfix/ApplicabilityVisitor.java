...
/**
 * This visitor should traverse the AST as much as needed to determine the nature of the replacement string, and then
 * return it through <code>isApplicable()</code>.
 *
