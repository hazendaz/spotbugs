...
/**
 * A <CODE>Comparator</CODE> used to add imports in a sorted order. The <CODE>ImportDeclaration</CODE> will be sorted
 * according to static or not static import, and then in an alphabetically order.
 *
