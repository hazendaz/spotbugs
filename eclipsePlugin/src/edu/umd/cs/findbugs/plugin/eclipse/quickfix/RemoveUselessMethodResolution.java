...
/**
 * Empty <CODE>finalize()</CODE> methods are useless, so they should be deleted. The same is valid for
 * <CODE>finalize()</CODE> methods that only call the superclass's <CODE>finalize()</CODE> method. The class
