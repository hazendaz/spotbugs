...
public enum SuppressMatchType {
    ...
    /**
     * Default bug suppression using a mixed prefixed / case insensitive match depending on the criterion. Suppress bugs
     * matching any of:
     * <ul>
    ...
    /**
     * Exact (case sensitive match). Suppress bugs matching any of:
     * <ul>
