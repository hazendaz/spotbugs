 ...
 * overriding method. Examples of such methods include finalize() and clone().
 *
 * The argument to the method indicates when the super invocation should occur: at any time, at the beginning of the
 * overriding method, or at the end of the overriding method.
 *
