...
class Issue3351Test extends AbstractIntegrationTest {
    ...
    void testSuppression() {
        performAnalysis("ghIssues/Issue3351.class", "ghIssues/Issue3351$Issue3351SuppressedNoSuchElement.class",
        ...
        assertBugInClassCount("US_USELESS_SUPPRESSION_ON_METHOD", "ghIssues.Issue3351$Issue3351SuppressedNoSuchElement",
                0);
        ...
        assertBugInClassCount("US_USELESS_SUPPRESSION_ON_METHOD",
                "ghIssues.Issue3351$Issue3351NotSuppressedNoSuchElement", 0);
