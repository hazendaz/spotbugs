...
class Issue3069Test extends AbstractIntegrationTest {
    ...
    @Test
    void testIssue() {
        performAnalysis("ghIssues/Issue3069.class", "org/rocksdb/AbstractImmutableNativeReference.class",
                "org/rocksdb/AbstractNativeReference.class", "org/rocksdb/ReadOptions.class",
