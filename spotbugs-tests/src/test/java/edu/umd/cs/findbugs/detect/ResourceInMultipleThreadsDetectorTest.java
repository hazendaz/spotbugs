...
class ResourceInMultipleThreadsDetectorTest extends AbstractIntegrationTest {
    ...
    void testSafeUsages() {
        performAnalysis("commonResources/SafeAtomicFieldUsage.class",
                "commonResources/SafeSynchronizedCollectionUsage.class", "commonResources/SafeFieldUsages.class",
                "commonResources/SynchronizedSafeFieldUsage.class", "commonResources/SafeFieldGetterUsage.class",
                "commonResources/SafeBuilderPattern.class", "commonResources/SafePutFieldWithBuilderPattern.class",
                "commonResources/SafeFieldUsageInMainThread.class",
                "commonResources/CombinedThreadsInShutdownHook.class",
                "commonResources/CombinedThreadsInShutdownHook$1.class", "commonResources/Vehicle.class",
    ...
    void testUnsafeFieldUsages() {
        performAnalysis("commonResources/UnsafeFieldUsage.class", "commonResources/Vehicle.class",
                "commonResources/Vehicle$Builder.class");
    ...
    void testUnsafeFieldUsages2() {
        performAnalysis("commonResources/UnsafeFieldUsage2.class", "commonResources/Vehicle.class",
                "commonResources/Vehicle$Builder.class");
    ...
    void testUnsafeFieldUsages3() {
        performAnalysis("commonResources/UnsafeFieldUsage3.class", "commonResources/Vehicle.class",
                "commonResources/Vehicle$Builder.class");
        assertBugTypeCount("AT_UNSAFE_RESOURCE_ACCESS_IN_THREAD", 2);
    ...
    void testUnsafeFieldUsages4() {
        performAnalysis("commonResources/UnsafeFieldUsage4.class", "commonResources/Vehicle.class",
                "commonResources/Vehicle$Builder.class");
        assertBugTypeCount("AT_UNSAFE_RESOURCE_ACCESS_IN_THREAD", 2);
    ...
    void testSynchronizedUnsafeFieldUsage() {
        performAnalysis("commonResources/SynchronizedUnsafeFieldUsage.class", "commonResources/Vehicle.class",
                "commonResources/Vehicle$Builder.class");
        assertBugTypeCount("AT_UNSAFE_RESOURCE_ACCESS_IN_THREAD", 2);
        assertBugInMethodAtLine("AT_UNSAFE_RESOURCE_ACCESS_IN_THREAD", "SynchronizedUnsafeFieldUsage", "lambda$new$0",
                8);
        assertBugInMethodAtLine("AT_UNSAFE_RESOURCE_ACCESS_IN_THREAD", "SynchronizedUnsafeFieldUsage", "createVehicle",
                16);
    }
}
