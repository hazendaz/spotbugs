...
class Issue2965Test extends AbstractIntegrationTest {
    ...
    void testIssue() {
        ...
        assertNoBugInMethod("NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE", "ghIssues.Issue2965",
                "checkForNullRequireNonNull");
        assertNoBugInMethod("NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE", "ghIssues.Issue2965",
                "checkForNullRequireNonNullWithMessage");
        assertNoBugInMethod("NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE", "ghIssues.Issue2965",
                "checkForNullRequireNonNullWithMessageMultiLine");
        assertNoBugInMethod("NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE", "ghIssues.Issue2965",
                "checkForNullRequireNonNullWithMessageSupplier");
        assertNoBugInMethod("NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE", "ghIssues.Issue2965", "conditionalCheckForNull");
        assertNoBugInMethod("NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE", "ghIssues.Issue2965",
                "springNullableRequireNonNull");
        assertNoBugInMethod("NP_NULL_ON_SOME_PATH_FROM_RETURN_VALUE", "ghIssues.Issue2965",
                "checkForNullRequireNonNullChainedCall");
