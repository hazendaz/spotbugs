...
public class BugExplorerViewTest extends AbstractBugExplorerViewTest {
    ...
    private ExpectedViewElement createProjectPatternMarkerExpectedContents() {
        ...
        ExpectedViewElement expectedProject = new ExpectedViewBugGroup(GroupType.Project, getProject(),
                setOf(expectedPattern1, expectedPattern2), setOf(expectedMarker1, expectedMarker2));
